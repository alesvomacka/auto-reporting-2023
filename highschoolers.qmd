...
params:
 selected_school: "Gymnázium Brno, Křenová"
editor: visual
echo: false
message: false
warning: false
...
```{r custom-functions}
# functions for stuff that gets repeated a lot. Ideally *shouldn't be defined inside .qmd file but in a seperate script (or package)
...
teaching_satisfaction |> 
  ...
  geom_text(position = position_stack(vjust = 0.5),
            size = rel(5.5),
            color = if_else(teaching_satisfaction$response == "Něco mezi",
                            true = "black",
                            false = "white")) +
...
Žáci gymnázií nejčastěji očekávají, že studium na vysoké škole jim přinese `r listify(top_expectations)`.
